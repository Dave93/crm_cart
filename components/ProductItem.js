      ...
      <div className="relative">
        {modifiers.length ? (
            ...
            {({ open }) => (
              <>
                <div>
                  ...
                  {!product.AVAILABLE && (
                    <div className="bg-red-100 px-3 py-3 rounded-md text-red-700 text-center">
                      Товар недоступен
                    </div>
                  )}
                </div>
          ...
          <div>
            ...
            {!product.AVAILABLE && (
              <div className="bg-red-100 px-3 py-3 rounded-md text-red-700 text-center absolute top-0 w-full h-full bg-opacity-50 flex items-center justify-around">
                Товар недоступен
              </div>
            )}
          </div>
